...
**All adapters use LoRA rank 16.** Co-serving adapters of different ranks forces vLLM's fused kernels to pad compute tiles to the maximum rank present, degrading lower-rank adapters' P95 latency by up to 84% (LoRAServe, arXiv:2511.22880). Every `goal.md` must specify `adapter_rank: 16`.
